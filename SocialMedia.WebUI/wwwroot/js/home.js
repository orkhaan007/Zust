...
function updateLayoutView() {
    $.ajax({
        ...
        success: async function (response) {
            ...
            $("#layoutProfileImageUrl").attr('src', `${currentUser.imageUrl}`);
            ...
            for (let i = 0; i < sentFriendRequests.length; i++) {
                ...
                <div class="item d-flex align-items-center">
                                                <div class="figure">
                                                    <a href="#"><img src="${sentFriendRequests[i].sender.imageUrl}" class="rounded-circle" alt="image"></a>
                                                </div>
                ...
                success: function (response) {
                    ...
                    for (let i = 0; i < chats.length; i++) {
                        ...
                        <div class="item d-flex justify-content-between align-items-center">
                            <div class="figure">
                                <a href="#"><img src="${sender.imageUrl}" class="rounded-circle" alt="image"></a>
                            </div>
                            <div class="text">
            ...
            for (let i = 0; i < notifications.length; i++) {
                ...
                <div class="item d-flex justify-content-between align-items-center">
                    <div class="figure">
                        <a href="#">
                            <img src="${notifications[i].sender.imageUrl}" class="rounded-circle" alt="image" />
                        </a>
                    </div>
                    <div class="text">
...
async function updateIndexView() {
    ...
    await $.ajax({
        ...
        success: function (response) {
            const currentUser = response.user;
            $("#indexUserImagePath").attr('src', currentUser.imageUrl);
...
function updateSpecialChat(senderId) {
    $.ajax({
        ...
        success: function (response) {
            ...
            $("#senderImage").attr('src', `${user.imageUrl}`);
                            ...
                            <div class='${messages[i].senderId === currentUser.id ? "chat chat-left" : "chat"}' >
                                <div class="chat-avatar">
                                    <a class="d-inline-block">
                                        <img src="${messages[i].sender.imageUrl}" width="50" height="50" class="rounded-circle" alt="image">
                                    </a>
                                </div>
                                <div class="chat-body">
