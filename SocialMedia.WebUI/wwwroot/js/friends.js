        ...
        <div class="col-lg-3 col-sm-6">
            <div class="single-friends-card">
                <div class="friends-image">
                    <a href="#">
                        <img src="${otherUser.backgroundImageUrl}.jpg" alt="image">
                    </a>
                    <div class="icon">
                ...
                <div class="friends-content">
                    <div class="friends-info d-flex justify-content-between align-items-center">
                        <a href="#">
                            <img src="${otherUser.imageUrl}" style="width: 100px; height: 100px;" alt="image">
                        </a>
                        <div class="text ms-3">
...
async function updatePeopleYouKnow(key) {
    ...
    <div class="single-friends-card">
        <div class="friends-image">
            <a href="#">
                <img src="${users[i].backgroundImageUrl}" alt="image">
            </a>
            <div class="icon">
                <a href="#"><i class="flaticon-user"></i></a>
            </div>
        ...
        <div class="friends-content">
            <div class="friends-info d-flex justify-content-between align-items-center">
                <a href="#">
                    <img src="${users[i].imageUrl}" alt="image">
                </a>
                <div class="text ms-3">
...
<div class="col-lg-3 col-sm-6">
    <div class="single-friends-card">
        <div class="friends-image">
            <a href="#">
                <img src="${friend.backgroundImageUrl}" alt="image">
            </a>
            <div class="icon">
                <a href="#"><i class="flaticon-user"></i></a>
            </div>
        ...
        <div class="friends-content">
            <div class="friends-info d-flex justify-content-between align-items-center">
                <a href="#">
                    <img src="${friend.imageUrl}"  alt="image">
                </a>
                <div class="text ms-3">
